...
from onixbind.openfold.utils.tensor_utils import add, one_hot
...
from onixbind.openfold.model.pairformer import Transition, AttentionPairBias, AdaLN
from onixbind.openfold.utils.atom_token_conversion import repeat_consecutive_with_lens, concat_previous_and_later_windows, pad_at_dim, mean_pool_with_lens
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.relative_positions_encoding = RelativePositionEncoding(
            ...
            r_max=r_max,
            s_max=s_max,
            mapping=self.advanced_conditioning,
            )
