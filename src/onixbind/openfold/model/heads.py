...
from onixbind.openfold.utils.precision_utils import is_fp16_enabled
from onixbind.openfold.model.pairformer import PairformerStack
...
class AuxiliaryHeads(nn.Module):
    ...
    def forward(self, outputs, feats):
        aux_out = {}
        aux_out["distogram_logits"] = self.distogram(outputs["z"])
